  ...
  return (
    <Layout>
      ...
      <FullWidthContainer className="text-mpo-bg-dark mt-16">
        ...
        <Link href='https://www.eventbrite.com/e/muskoka-philharmonic-orchestra-in-concert-whimsical-musings-tickets-822544311177?aff=oddtdtcreator' className="rounded text-2xl mb-8 p-2 cursor-pointer underline">
