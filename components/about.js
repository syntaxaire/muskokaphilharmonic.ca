      ...
      <div className="py-8 px-4 mx-auto max-w-screen-lg lg:py-16 lg:px-6">
        <div className="max-w-screen-lg sm:text-lg">
          ...
          <p className="mb-4 text-normal">
            ...
            Music Education (Wilfrid Laurier University), and a Bachelor of
            Education (Nipissing University).
          </p>
          <p>
            Alana has been a member of the Orillia Silver Band, Muskoka Concert
            Band, Sudbury Symphony Orchestra, Spirit of the Lakes Drum and Bugle
            Corps, and many Salvation Army brass bands throughout the years.
          </p>
          <p>
            As a Music Director, Alana has led choirs, bands, pit orchestras,
            and now is the Artistic Director/Co-Founder of the newly formed
            Muskoka Philharmonic Orchestra.
          </p>
          <p>
            Alana is thrilled to be working with a passionate group of musicians
            who share the same love of collaboration, growth, and performance
