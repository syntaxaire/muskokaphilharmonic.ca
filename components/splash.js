      ...
      <div className='relative py-8 px-4 mx-auto max-w-screen-lg text-white lg:py-16 z-1'>
        <div className='mb-6 max-w-screen-lg lg:mb-0'>
          ...
          <a
            ...
            className='py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'
            target='_blank'
          >
            <button
              type='button'
          ...
          <a
            href='/events/2023-11-26/Blue Festive MPO Nov Poster - digital.pdf'
            className='py-2 pl-3 pr-4 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent'
            target='_blank'
          >
            <button
        ...
        <Image
          ...
          alt='Concert announcement for November 26, 2023'
          width='940'
          height='470'
        />
      </div>
